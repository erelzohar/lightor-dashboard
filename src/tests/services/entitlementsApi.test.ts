...
describe('fetchMyEntitlements', () => {
  ...
  const entitlements = {
    plan: 'free',
    limits: { monthlyAppointments: 30, maxServices: 3, hourlyReminder: false, aiGenerationsPerMonth: 5, aiEditsPerMonth: 10, aiTokensPerMonth: null as number | null, showBranding: true },
